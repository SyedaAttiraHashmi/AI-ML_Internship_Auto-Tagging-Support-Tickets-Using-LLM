...
Objective
This project automates the classification of customer support tickets using a Large Language Model (LLM). The focus is on transforming messy, free-text data into structured categories to streamline support workflows.
...
Methodology
The system uses a modular Python architecture to process data and interact with the LLM.
...
Zero-Shot: Provided accurate general themes but lacked consistent label naming (e.g., mixing "WiFi" and "Network").
...
1. Prerequisites
Ensure you have Python installed and a Groq API Key.
